...
public class Vetement extends Contenu {
    ...
    /**
     * Permet de déterminer à quelle Entité de la BD appartient un vêtement en
    ...
    /**
     * Permet de savoir si le vêtement correspond au signe de la forme de
     * l'utilisateur
     *
     * @param u Utilisateur
    ...
    /**
     * Permet de demander à l'utilisateur les caractéristiques nécessaires à la
     ...
     * @return boolean Vrai si tout s'est bien passé, Faux si une erreur est
     * survenue
     *
     */
    ...
    /**
     * Permet d'initialiser les tableaux de vêtements contenu en attribut dans
     * la classe avec les données de la base
     *
    ...
    /**
     * Permet de supprimer un vêtements de chaque liste : hauts, hauts-bas, et
     * bas
     *
    ...
    /**
     * Permet d'afficher tous les vêtements du dressing correspondant à la
     * saison courante
     *
     * @param idDressing Id du dressing
     */
    ...
    /**
     * Permet d'obtenir tous les vêtements du dressing correspondant à la saison
     * courante
     *
     * @param idDressing Id du dressing
     */
    ...
    /**
     * Permet d'obtenir tous les vêtements du dressing correspondant à la
     * couleur préférée de l'utilisateur
     *
     * @param idDressing Id du dressing
     */
    ...
    /**
     * Permet d'afficher tous les vêtements du dressing correspondant à une
     * forme particulière rentrée par l'utilisateur
     *
     * @param idDressing Id du dressing
     */
    ...
    /**
     * Permet d'afficher tous les vêtements du dressing correspondant à un type
     * partivulier rentré par l'utilisateur
     *
     * @param idDressing Id du dressing
     */
...
public static boolean afficherVetementsSaleOuPropre(boolean estSale) {
     ...
     * @param mettreAuSale Vrai si on veut mettre un vêtement au sale, Faux
     * sinon
     */
